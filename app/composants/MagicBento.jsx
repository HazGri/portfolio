...
const cardData = [
  ...
  },
  {
    ...
    label: "Overview",
    image: "/images/spring-boot-icon.svg",
    classNameImg: "h-14 sm:h-20",
    classNameTxt: "lg:hidden",
  },
  {
  ...
  },
  {
    ...
    label: "Efficiency",
    image: "/images/cruiser-military-svgrepo-com.svg",
          ...
          {cardData.map((card, index) => {
            ...
            if (enableStars) {
              return (
                ...
                >
                  <div className="card__header flex justify-center gap-3 my-auto relative text-white">
                    {card.image && (
                      <img
                        src={card.image}
                  ...
                  <div
                    className={
                      "card__content flex flex-col relative text-white"
                    }
                  >
                    <h3
